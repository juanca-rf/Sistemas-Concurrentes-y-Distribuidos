...
{  
   if( bloc>lectoresPermitidosEscribiendo || escrib)
      lectura.wait();

   if(escritura.get_nwt()>0)
      bloc++;
      
   if(bloc < lectoresPermitidosEscribiendo)
      lectura.signal();
...
{
   cout << "-------------------------------------------------------------------------------" << endl
        << "Problema LectorEscritor con limitacion de lector. " << endl
        << "-------------------------------------------------------------------------------" << endl
        << flush ;
